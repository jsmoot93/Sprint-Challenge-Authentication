...
1. What is the purpose of using _sessions_?
   - Sessions are a way to try and introduce state between the server and client. It serves as a way to track if a user is logged in and has access to sensitive documents.
2. What does bcrypt do to help us store passwords in a secure manner.
   - BCrypt salts and hashes user passwords. If done properly, nobody should ever be able to actually see the real password.
3. What does bcrypt do to slow down attackers?
   - BCrypt slows down attacks because they need to know the correct salt, hashing algorithm, and the rounds used to encrypt the password.
